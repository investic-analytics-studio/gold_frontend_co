  ...
  return (
    ...
    >
      ...
      <p
        ...
        } text-gray-400 mb-8 mt-2 text-center max-w-[800px] mx-auto`}
      >
      ...
      <Card className="bg-[#050914] border-[#20293A] rounded-[30px] h-auto overflow-hidden mt-12">
        <CardContent className="p-0">
          <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 h-auto">
            <div
              className={`${
                isMobile
                  ...
                  : "md:border-r border-[#20293A] p-16 pt-16"
              }`}
            >
              <div className="flex items-center mb-4">
                <MonitorCheck className="w-[92px] h-[92px] text-[#209CFF] mr-4 mb-6" />
              </div>
              <h2 className="text-2xl font-medium text-white text-[30px]">
                Desktop Experience
              </h2>
              <p className="text-[#A1A1AA] text-[18px] mt-4">
            ...
            >
              <div className="flex items-center mb-4">
                <TabletSmartphone className="w-[92px] h-[92px] text-[#209CFF] mr-4 mb-6" />
              </div>
              <h2 className="text-2xl font-medium text-white text-[30px]">
                Mobile & Tablet Ready
              </h2>
