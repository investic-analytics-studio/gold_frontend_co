...
const fetchHistoricalData = async (symbol: string, interval: string): Promise<HistoricalBar[]> => {
...
const TradingViewChart = ({
  ...
  const initializeChart = () => {
    if (!chartContainerRef.current || !window.TradingView || !historicalData) return;
    ...
    const datafeed = {
      ...
      getBars: async (
        ...
        try {
          const bars = historicalData.map(bar => ({
        ...
        return Promise.resolve([
          {
            ...
            constructor: function(this: any) {
              const indicator: CustomIndicator = {
                ...
                init: function(context: IndicatorContext, input: (name: string) => any) {
                ...
                main: function(context: IndicatorContext, input: (name: string) => any) {
                  this._context = context;
                  this._input = input;
                  ...
                  for (let i = 0; i < bars; i++) {
                    result[i] = Math.random() * rowSize * valueAreaVolume / 100;
                  }
